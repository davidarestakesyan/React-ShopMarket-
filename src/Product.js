        ...
        <div className='prod-items'>
            <div >
                ...
                <img src={shoes.image} alt="" className="images"  />
                 {/* <img src={"/" + shoes.image2} alt="" className="images"  />
                 <img src={"/" + shoes.image3} alt="" className="images"  /> */}
                <h2  className='prod-item'>{shoes.name}</h2>
                <p className='prod-item'>{shoes.price}</p>
                <p className='prod-item'>{shoes.places}</p>
